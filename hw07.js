...
console.log("Matt's average marathon time is " + getAverageTime(matt) + " minutes");
console.log("Mark's average marathon time is " + getAverageTime(mark) + " minutes");
...
function getSumOfAccounts(account) {
  "use strict";
    return MattsBankAccount.checking + MattsBankAccount.savings + MattsBankAccount.retirement;// return ...
}
